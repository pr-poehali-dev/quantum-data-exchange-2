            ...
            <div className="flex items-start gap-4 text-left">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed max-w-2xl">
                  Все консультации предоставляются в письменном виде. Услуги носят информационно-консультационный и аналитический характер. 
                  Решения принимаете самостоятельно. Никаких гарантий результата.
                </p>
              </div>
            </div>
          </Card>
