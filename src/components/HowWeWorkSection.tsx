      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            Как <span className="text-primary">мы работаем</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Оказываем консультационные услуги в асинхронном формате: вы отправляете запрос — мы готовим письменный ответ. 
            Без обязательных звонков и встреч.
          </p>
        </div>
            ...
            <div className="flex items-start gap-4 text-left">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed max-w-2xl">
                  Все консультации предоставляются в письменном виде. Мы не гарантируем конкретных результатов или финансовых показателей. 
                  Услуги носят информационно-консультационный и аналитический характер. Решения принимаете вы самостоятельно на основе полученных рекомендаций.
                </p>
              </div>
            </div>
          </Card>
