...
const services = [
  {
    ...
    description:
      "Письменные аналитические разборы ситуаций: как распознавать структуру, просчитывать риски и принимать взвешенные решения.",
  },
  {
    icon: "Target",
    ...
    description:
      "Асинхронный формат работы: описываете задачу — получаете структурированный анализ с конкретными рекомендациями.",
  },
  {
    icon: "FileCheck",
