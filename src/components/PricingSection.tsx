...
const pricingTiers = [
  {
    ...
    price: "990",
    features: [
      "Консультационный пакет (до 5 запросов)",
      "Ответ в течение 48 часов в рабочие дни",
      "Информационные рекомендации",
      "Методические материалы",
      "Срок сопровождения: 30 дней",
    ],
    highlighted: false,
  },
  {
    ...
    price: "1 990",
    features: [
      "Пакет аналитической поддержки (до 10 запросов)",
      "Глубокий анализ ситуаций",
      "Расширенные материалы",
      "Ответ в течение 24 часов в рабочие дни",
      "Срок сопровождения: 60 дней",
    ],
    highlighted: true,
  },
  {
    ...
    price: "По запросу",
    features: [
      "Объём сопровождения по договорённости",
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Стоимость информационно-консультационных услуг зависит от объёма и срока сопровождения
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Оплата информационно-консультационных услуг через <span className="text-primary font-semibold">СБП</span> на расчётный счёт ИП.<br />
