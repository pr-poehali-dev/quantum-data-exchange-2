...
const formats = [
  {
    ...
    description:
      "Анализ ситуации через призму стратегического мышления. Письменные информационные рекомендации для типовых задач.",
    price: "от 990 ₽",
    tags: ["Письменный разбор", "Методические материалы", "Типовые рекомендации"],
  },
  {
    title: "Анализ сложных ситуаций",
    category: "Расширенный формат",
    description:
      "Глубокий аналитический разбор нестандартных задач. Оценка возможных сценариев в условиях неопределённости.",
    price: "от 1 990 ₽",
    tags: ["Структурирование", "Чек-листы", "Аналитика"],
  },
  {
    title: "Оценка вероятностей",
    category: "Глубокий аналитический разбор",
    description:
      "Консультации по анализу вероятностей и сценариев. Методические материалы для структурирования неопределённости.",
    price: "от 2 490 ₽",
  ...
  },
  {
    ...
    description:
      "Разбор механизмов выбора действий. Консультации по работе с когнитивными искажениями и импульсивностью.",
    price: "от 1 490 ₽",
  ...
  {
    title: "Анализ без полных данных",
    category: "Расширенный формат",
    description:
      "Информационные рекомендации при нехватке данных. Методы структурирования и оценки вариантов.",
    price: "от 1 690 ₽",
    tags: ["Эвристики", "Оценка вариантов", "Методологии"],
  },
  {
    title: "Коммуникационный анализ",
    category: "Глубокий аналитический разбор",
    description:
      "Консультационное сопровождение по структурированию коммуникации. Разбор сценариев взаимодействия.",
    price: "от 2 990 ₽",
    tags: ["Коммуникация", "Сценарии", "Структурирование"],
  },
  {
